...
class User extends Equatable {
  ...
  const User({
    ...
    required this.hasHyperwalletAccount,
    required this.isUsernameAutogenerated,
    required this.privacyShowUpcomingEvents,
    required this.privacyShowPastEvents,
    required this.privacyPastEventsIncludeHosted,
    required this.privacyPastEventsIncludeCollaborated,
    required this.privacyPastEventsIncludeAttended,
